...
resource "aws_subnet" "public_subnets" {
  ...
  availability_zone = data.aws_availability_zones.azs[aws_subnet.public_subnets.key]
...
resource "aws_subnet" "private_subnets" {
  ...
  cidr_block = each.value
  availability_zone = data.aws_availability_zones.azs[aws_subnet.private_subnets.key]
  vpc_id   = aws_vpc.vpc_dev_test.id
  tags = {
